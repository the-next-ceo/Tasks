...
//import { returnText } from './extension';
...
export class activityBar implements vscode.WebviewViewProvider {
    ...
    */
    private getHtmlWebView(webview: vscode.Webview) {
        ...
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this._uri, 'out', 'compiled/bundle.js')
        );
        const styleUri = webview.asWebviewUri(vscode.Uri.joinPath(this._uri, 'out', 'compiled/bundle.css')
        );
